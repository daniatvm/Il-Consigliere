    ...
    try {
      await db.sequelize.transaction(async t => {
        ...
        const mailOptions = {
          ...
          text:
            `Los administradores del Consejo de Ingeniería en Computación del Campus Tecnológico Local de San José han solicitado que seas un participante en el Consejo, por favor haz click en la siguiente dirección y llena los datos solicitados:\n\nhttps://il-consigliere.herokuapp.com/gUsuarios/registro/${token}\n\nSe le recuerda que esta dirección expirará en 3 horas.\n\nSaludos,\nConsejo de Ingeniería en Computación.`
        };
